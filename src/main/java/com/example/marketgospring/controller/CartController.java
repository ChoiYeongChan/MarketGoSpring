...
public class CartController {
    ...
    @PostMapping
    public Cart put(@RequestParam("goodsId1") Goods goodsId1, @RequestParam("goodsId2") Goods goodsId2, @RequestParam("goodsId3") Goods goodsId3, @RequestParam("goodsId4") Goods goodsId4, @RequestParam("goodsId5") Goods goodsId5, @RequestParam("goodsId6") Goods goodsId6, @RequestParam("goodsId7") Goods goodsId7, @RequestParam("goodsId8") Goods goodsId8, @RequestParam("goodsId9") Goods goodsId9, @RequestParam("goodsId10") Goods goodsId10, @RequestParam("unit1") Integer unit1, @RequestParam("unit1") Integer unit2, @RequestParam("unit1") Integer unit3, @RequestParam("unit1") Integer unit4, @RequestParam("unit1") Integer unit5, @RequestParam("unit1") Integer unit6, @RequestParam("unit1") Integer unit7, @RequestParam("unit1") Integer unit8, @RequestParam("unit1") Integer unit9, @RequestParam("unit1") Integer unit10) {
